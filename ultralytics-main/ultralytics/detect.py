...
if __name__ == '__main__':
    model = YOLO('/mnt/d/Code/ultralytics-20250601/ultralytics-main/runs/val/train/exp/weights/best.pt') # select your model.pt path
    model.predict(source='/mnt/d/Code/ultralytics-20250601/ultralytics-main/dataset/GC10-DET/test/images',
                  imgsz=640,
                  project='runs/detect',
                  name='exp',
                  save=True,
