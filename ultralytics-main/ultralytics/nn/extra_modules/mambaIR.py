...
try:
    ...
    try:
        from mamba_ssm.ops.selective_scan_ref import selective_scan_ref as selective_scan_fn
    except Exception as e:
        raise ImportError(
            "selective_scan_fn not found. Install 'mamba-ssm' (and 'causal-conv1d'), "
            "or temporarily use the ref implementation. Original error: %r" % e
        )
