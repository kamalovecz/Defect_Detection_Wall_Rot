...
class SimAM(torch.nn.Module):
    ...
    # SimAM: A Simple, Parameter-Free Attention Module for Vision Transformers;不要任何可学习的参数，只靠像素与本通道的平均值的差异生成注意力权重
    ...
    def forward(self, x):
        ...
        x_minus_mu_square = (x - x.mean(dim=[2, 3], keepdim=True)).pow(2) #通道内均值
        # 计算每个通道的注意力权重
